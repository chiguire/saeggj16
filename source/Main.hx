...
class Main extends Sprite 
{
	...
	var initialState:Class<FlxState> = SplashState; // The FlxState the game starts with.	var zoom:Float = -1; // If -1, zoom is automatically calculated to fit the window dimensions.
	var zoom:Float = -1;
